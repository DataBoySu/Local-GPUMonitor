...
> *MyGPU: एक हल्का GPU प्रबंधन उपकरण: nvidia-smi का एक संक्षिप्त `nvidia-smi` लेपरिन के साथ एक सुंदर वेब डैशबोर्ड।*

<!-- इस बैज खंड को अनुवाद न करें, इसे जैसा है रखें -->
...
<details>
  ...
  <div style="display:flex; overflow-x:auto; gap:10px; padding:12px 0; scroll-snap-type:x mandatory; -webkit-overflow-scrolling:touch;">
    <!-- पहली छवि का पहला फ्रेम 1624x675 के अनुपात में उपयोग करें; छवियाँ object-fit:contain का उपयोग करके अंदर फिट हो जाती हैं -->
...
- **विकासकर्ता अनुकूल**: तनाव परीक्षण और स्थिरता का परीक्षण करने के लिए जेएमजीएम (GEMM) लोड और 3डी कण भौतिकी का इंटरैक्टिव दृश्यात्मक प्रदर्शन।
...
- **प्रशासक और प्रवर्तन**:
  ...
  - **स्वचालित समापन**: प्रशासक केवल VRAM नीतियों का उल्लंघन करने वाली प्रक्रियाओं को स्वचालित रूप से समाप्त कर सकते हैं (केवल प्रशासक के लिए)।
  - **देखने वाली सूचियाँ**: विशिष्ट PIDs या प्रक्रिया नामों की निगरानी करें।

- **बेंचमार्किंग और सिमुलेशन**:
  - **तनाव परीक्षण**: जेएमजीएम (GEMM) लोड का परीक्षण करें ताकि थर्मल थ्रॉटलिंग और स्थिरता का परीक्षण किया जा सके।
  - **कण भौतिकी का दृश्यात्मक प्रदर्शन**: प्रक्रिया को समझने के लिए इंटरैक्टिव 3डी कण भौतिकी सिमुलेशन।
...
- **बहु-GPU समर्थन**: NVLink टॉपोलॉजी के लिए बेहतर हैंडलिंग के साथ एनाग्नेस्ट हैंडलिंग के लिए।
- **कंटेनराइजेशन**: आधिकारिक डॉकर समर्थन के लिए आसान तैनाती के लिए।
- **दूरस्थ पहुँच**: SSH टनलिंग एकीकरण और सुरक्षित दूरस्थ प्रबंधन के लिए।
- **क्रॉस-प्लेटफ़ॉर्म**:
